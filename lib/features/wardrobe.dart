          ...
          for (final e in items.entries.where(
            ...
            Padding(
              ...
              child: ListTile(
                ...
                tileColor: w.outfit == e.key ? Brand.mint : Colors.white,
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(22),
                ),
                leading: Icon(
                  w.owned.contains(e.key)
                      ? Icons.checkroom_rounded
                      : Icons.lock_outline_rounded,
                ),
                title: Text(e.value.first),
                subtitle: Text(e.value.last),
                trailing: w.outfit == e.key
                    ? const Icon(Icons.check_circle_rounded, color: Brand.sage)
                    : null,
                onTap: !w.owned.contains(e.key)
                    ? null
                    : () => app.change((next) {
                        next.outfit = e.key;
                        next.dialogue = e.key == 'astronaut'
                            ? 'A space adventure? I have just the helmet!'
                            : 'This feels like me!';
